package ec.edu.uce.proyecto_final_1h_g08.vista;
...
import ec.edu.uce.proyecto_final_1h_g08.R;
import ec.edu.uce.proyecto_final_1h_g08.controlador.VehiculoControlador;
import ec.edu.uce.proyecto_final_1h_g08.modelo.Vehiculo;
                ...
                if (!validarplaca.matches() || plac.getText().equals("")) {
                    ...
                    if (!validarfecha.matches() || fech.getText().equals("")){
                        ...
                        try {
                            ...
                            Vehiculo vehiculo = new Vehiculo(placa, marca, fecha, costo, matriculado, scolor);
