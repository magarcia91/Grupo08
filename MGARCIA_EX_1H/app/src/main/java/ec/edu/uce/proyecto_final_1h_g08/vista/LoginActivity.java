...
import ec.edu.uce.proyecto_final_1h_g08.modelo.Usuario;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usuario1 = new Usuario("miguel", "garcia");
        usuario2 = new Usuario("dayana", "diaz");
        usuario3 = new Usuario("diego", "vallejo");
